...
public class UserController {
    ...
    public String showEditForm(@PathVariable Long id, Model model) {
        ...
        return "users/edit"; // шаблон: src/main/resources/templates/users/edit.html
    }
    ...
    public String registerUser(@ModelAttribute User user) {
        ...
        userService.createUser(user);
        // Переадресация на страницу со статьями после успешной регистрации
        return "redirect:/articles"; // Здесь вы можете указать путь к странице, например /articles
    }
}
